...
- `IN_REVIEW` P0.9 provides a compact worker contract, bounded inference and unsafe-call correction, progress-aware package repair, exact latest-entrypoint readback, browser interaction validation, retained proof, and direct embedded opening. Focused backend proof passes; clean-slate live GUI delivery and manual novice review remain required.

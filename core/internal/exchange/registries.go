...
var SeedSchemas = []SchemaDefinition{
	...
	{ID: "LearningCandidate", Label: "Learning Candidate", Description: "Candidate learning signal surfaced for future synthesis or promotion.", RequiredFields: []string{"summary", "status", "confidence", "tags", "continuity_key", "created_at"}, OptionalFields: []string{"source_role", "target_role", "updated_at", "sensitivity_class", "capability_id", "trust_class", "review_required", "allowed_consumers", "source_team", "target_team"}, RequiredCapabilities: []string{"learning"}},

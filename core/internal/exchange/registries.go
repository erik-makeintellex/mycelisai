...
var SeedFields = []FieldDefinition{
	...
	{Name: "run_id", Type: "string", SemanticMeaning: "Execution run identifier when the output is linked to a concrete run.", Indexed: true, Visibility: "admin", UsageContexts: []string{"artifact", "message", "thread"}},
	{Name: "run_class", Type: "enum", SemanticMeaning: "Explicit classification for whether the output is run-linked or no-run.", Indexed: true, Visibility: "admin", UsageContexts: []string{"artifact", "message", "thread"}},
	{Name: "no_run_reason", Type: "string", SemanticMeaning: "Reason no execution run is attached to the output.", Indexed: true, Visibility: "admin", UsageContexts: []string{"artifact", "message", "thread"}},
	{Name: "retention_class", Type: "enum", SemanticMeaning: "Output retention posture such as retained or non-retained.", Indexed: true, Visibility: "admin", UsageContexts: []string{"artifact", "message", "thread"}},
...
var SeedSchemas = []SchemaDefinition{
	{ID: "TextResult", Label: "Text Result", Description: "Plain language output intended for review or handoff.", RequiredFields: []string{"summary", "status", "source_role", "target_role", "created_at"}, OptionalFields: []string{"confidence", "tags", "continuity_key", "run_id", "run_class", "no_run_reason", "retention_class", "updated_at", "sensitivity_class", "capability_id", "trust_class", "review_required", "allowed_consumers", "source_team", "target_team"}, RequiredCapabilities: []string{"text_output"}},
	{ID: "PlanResult", Label: "Plan Result", Description: "Structured planning output for work design and coordination.", RequiredFields: []string{"summary", "status", "priority", "source_role", "target_role", "created_at"}, OptionalFields: []string{"tags", "continuity_key", "run_id", "run_class", "no_run_reason", "retention_class", "updated_at", "sensitivity_class", "capability_id", "trust_class", "review_required", "allowed_consumers", "source_team", "target_team"}, RequiredCapabilities: []string{"planning"}},
	{ID: "ReviewResult", Label: "Review Result", Description: "Review, critique, or governance feedback on work already produced.", RequiredFields: []string{"summary", "status", "confidence", "source_role", "target_role", "created_at"}, OptionalFields: []string{"tags", "continuity_key", "run_id", "run_class", "no_run_reason", "retention_class", "updated_at", "sensitivity_class", "capability_id", "trust_class", "review_required", "allowed_consumers", "source_team", "target_team"}, RequiredCapabilities: []string{"review"}},
	{ID: "MediaResult", Label: "Media Result", Description: "Media output such as generated imagery or referenced audio/video assets.", RequiredFields: []string{"summary", "status", "artifact_uri", "source_role", "target_role", "created_at"}, OptionalFields: []string{"confidence", "tags", "continuity_key", "run_id", "run_class", "no_run_reason", "retention_class", "updated_at", "sensitivity_class", "capability_id", "trust_class", "review_required", "allowed_consumers", "source_team", "target_team"}, RequiredCapabilities: []string{"media_output"}},
	{ID: "FileResult", Label: "File Result", Description: "File-oriented output intended for later delivery or inspection.", RequiredFields: []string{"summary", "status", "artifact_uri", "source_role", "target_role", "created_at"}, OptionalFields: []string{"tags", "continuity_key", "run_id", "run_class", "no_run_reason", "retention_class", "updated_at", "sensitivity_class", "capability_id", "trust_class", "review_required", "allowed_consumers", "source_team", "target_team"}, RequiredCapabilities: []string{"file_output"}},
	{ID: "ToolResult", Label: "Tool Result", Description: "Normalized output from MCP or service/tool invocations.", RequiredFields: []string{"summary", "status", "source_role", "target_role", "created_at"}, OptionalFields: []string{"artifact_uri", "confidence", "tags", "continuity_key", "run_id", "run_class", "no_run_reason", "retention_class", "updated_at", "sensitivity_class", "capability_id", "trust_class", "review_required", "allowed_consumers", "source_team", "target_team"}, RequiredCapabilities: []string{"tool_execution"}},
...
var SeedCapabilities = []CapabilityDefinition{
	...
	{ID: "team_orchestration", Label: "Team Orchestration", Source: "internal_tool", RiskClass: "medium-risk", DefaultAllowedRoles: []string{"soma", "team_lead", "automation"}, AuditRequired: true, ApprovalRequired: false, Description: "Runtime team creation, delegation, and bus-scoped coordination."},

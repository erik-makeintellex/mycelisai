...
func TestHandleSaveArtifactToFolder(t *testing.T) {
	...
	// Ensure file was created in workspace.
	if _, err := os.Stat(workspace + string(os.PathSeparator) + strings.ReplaceAll(payload["file_path"], "/", string(os.PathSeparator))); err != nil {

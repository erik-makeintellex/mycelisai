...
func (s *AdminServer) RegisterRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("POST /api/v1/teams/{id}/work/ask", s.HandleTeamWorkAsk)
	...
	mux.HandleFunc("GET /api/v1/outcome-projects", s.HandleListOutcomeProjects)
	mux.HandleFunc("POST /api/v1/outcome-projects", s.HandleCreateOutcomeProject)
	mux.HandleFunc("GET /api/v1/outcome-projects/{id}", s.HandleGetOutcomeProject)
	mux.HandleFunc("GET /api/v1/outcome-projects/{id}/team-registry", s.HandleListTeamRegistryEntries)
	mux.HandleFunc("POST /api/v1/outcome-projects/{id}/team-registry", s.HandleCreateTeamRegistryEntry)
	...
	mux.HandleFunc("POST /api/v1/groups/{id}/clear", s.HandleClearGroup)
	...
	mux.HandleFunc("POST /api/v1/config-documents/dry-run", s.HandleConfigDocumentDryRun)
	...
	mux.HandleFunc("GET /api/v1/code-context/sources", s.HandleCodeContextSources)
	mux.HandleFunc("POST /api/v1/code-context/sources", s.HandleCodeContextSources)
	mux.HandleFunc("POST /api/v1/code-context/index", s.HandleCodeContextIndex)
	mux.HandleFunc("POST /api/v1/code-context/query", s.HandleCodeContextQuery)
	mux.HandleFunc("POST /api/v1/code-context/impact", s.HandleCodeContextImpact)
	mux.HandleFunc("POST /api/v1/code-context/explain", s.HandleCodeContextExplain)
	mux.HandleFunc("GET /api/v1/input-sources", s.HandleInputSources)
	mux.HandleFunc("POST /api/v1/input-sources", s.HandleInputSources)
	mux.HandleFunc("GET /api/v1/input-sources/{id}", s.HandleInputSource)
	mux.HandleFunc("PATCH /api/v1/input-sources/{id}", s.HandleInputSource)
	mux.HandleFunc("DELETE /api/v1/input-sources/{id}", s.HandleInputSource)
	mux.HandleFunc("GET /api/v1/input-sources/{id}/buffer", s.HandleInputSourceBuffer)

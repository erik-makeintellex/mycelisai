...
- `NEXT` replace remaining Kind-biased local Kubernetes assumptions across ops/docs/tests with `k3d` and add enterprise-simulated local proof for ingress, storage, secrets/config posture, and promoted Helm values.

...
9. `NEXT` finish the enterprise workflow certification by reconnecting the create -> open group -> review outputs browser story through the guided `/teams/create` lane once the current org-context browser harness is stabilized again.

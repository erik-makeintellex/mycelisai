...
| P0.8 | Outcome journey proof | Full journey | IN_REVIEW | Deterministic journey plus Outcome Ownership/default recovery ownership and live smoke proof are green; remaining gate is live run-event reconstruction |

...
| [V8.3 MVP UI Runtime Delivery Plan](V8_3_MVP_UI_RUNTIME_DELIVERY_PLAN.md) | executable delivery overlay for Soma inbox, run receipts, output packages, capability catalog, recovery queue, and Trusted Outcome Journey proof |

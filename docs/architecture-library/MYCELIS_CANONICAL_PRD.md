...
| P0.3 | WorkIntent and ExecutionMode | ACTIVE | Understand, Execute | One-shot, scheduled, service/watch, project, and Soma self-extension modes have typed contracts, stop/retry/recover semantics, output-shape expectations, validation/launch hints, and approval posture without expanding the default approval card. |

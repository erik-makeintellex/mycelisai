...
| P0.7a | Search source registry | ACTIVE | Registry-preview sources are visible in search status and Resources; persisted add/edit for web, local, and authenticated client-owned sources is next. |

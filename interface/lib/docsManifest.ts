...
export const DOC_MANIFEST: DocSection[] = [
    {
        ...
        docs: [
            ...
            { slug: "resources-guide", label: "Resources", path: "docs/user/resources.md", description: "Capabilities, MCP structure review, output files, AI engines, and governed context" },
    ...
    },
    {
        ...
        docs: [
            ...
            { slug: "v8-3-release-architecture-delivery-brief", label: "V8.3 Release Architecture Brief", path: "docs/architecture-library/V8_3_RELEASE_ARCHITECTURE_DELIVERY_BRIEF.md", description: "Compact shareable architecture document for MVP-to-release execution, delivery lanes, P0 train, proof, and acceptance standard" },
            { slug: "v8-3-product-manifestation-review", label: "V8.3 Product Manifestation Review", path: "docs/architecture-library/V8_3_PRODUCT_MANIFESTATION_REVIEW.md", description: "Product-value review of major subsystems, visibility boundaries, MVP classification, and adoption risk" },
            { slug: "v8-3-soma-user-experience-contract", label: "V8.3 Soma UX Contract", path: "docs/architecture-library/V8_3_SOMA_USER_EXPERIENCE_CONTRACT.md", description: "Operator-first contract for working through Soma, deliverables, proof, recovery, capabilities, and optional Inspect" },
            { slug: "v8-3-mvp-ui-runtime-delivery-plan", label: "V8.3 MVP UI Runtime Delivery", path: "docs/architecture-library/V8_3_MVP_UI_RUNTIME_DELIVERY_PLAN.md", description: "Executable plan for Soma inbox, run receipts, output packages, capability catalog, recovery queue, and advanced run-map proof" },

...
export const DOC_MANIFEST: DocSection[] = [
    ...
    },
    {
        ...
        docs: [
            ...
            { slug: "v8-3-ui-ux-engineering-implementation-brief", label: "V8.3 UI/UX Engineering Brief", path: "docs/architecture-library/V8_3_UI_UX_ENGINEERING_IMPLEMENTATION_BRIEF.md", description: "Threaded Soma workspace, rich action cards, action library, outcome vault, zero-friction settings, event binding, and target visual system" },

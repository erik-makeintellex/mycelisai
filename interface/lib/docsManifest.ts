...
export const DOC_MANIFEST: DocSection[] = [
    ...
    },
    {
        ...
        docs: [
            ...
            { slug: "source-file-size-indexing", label: "Source File Size + Indexing", path: "docs/architecture-library/SOURCE_FILE_SIZE_AND_INDEXING_PLAN.md", description: "File-size hygiene and source indexing rules for repo maintainability" },

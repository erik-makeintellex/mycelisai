...
export const DOC_MANIFEST: DocSection[] = [
    ...
    },
    {
        ...
        docs: [
            ...
            { slug: "v8-3-mvp-ui-runtime-delivery-plan", label: "V8.3 MVP UI Runtime Delivery", path: "docs/architecture-library/V8_3_MVP_UI_RUNTIME_DELIVERY_PLAN.md", description: "Executable plan for Soma inbox, run receipts, output packages, capability catalog, recovery queue, and Trusted Outcome Journey proof" },

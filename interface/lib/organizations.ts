...
export type OrganizationAIEngineProfileId =
  | "starter_defaults"
  | "balanced"
  | "high_reasoning"
  | "fast_lightweight"
  | "deep_planning";
export type ResponseContractProfileId =
  | "clear_balanced"
  | "structured_analytical"
  | "concise_direct"
  | "warm_supportive";
export type OrganizationOutputModelRoutingMode =
  | "single_model"
  | "detected_output_types";
export type OrganizationOutputTypeId =
  | "general_text"
  | "research_reasoning"
  | "code_generation"
  | "vision_analysis";
...
export type OrganizationLearningInsightStrength =
  | "emerging"
  | "consistent"
  | "strong";
...
export type TeamLeadGuidedAction =
  | "plan_next_steps"
  | "focus_first"
  | "review_setup"
  | "resume_retained_package";
export type TeamLeadExecutionMode =
  | "guided_review"
  | "native_team"
  | "external_workflow_contract"
  | "continuity_resume";

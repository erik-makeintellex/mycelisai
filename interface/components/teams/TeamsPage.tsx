            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="mt-2 text-sm leading-6 text-cortex-text-muted">
                  ...
                  finished ask to Soma. Return here after launch to open the
                  team lead, review the current roster, and maintain the member
                  templates Soma should reuse on future team builds.
                </p>

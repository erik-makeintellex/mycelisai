...
function ArtifactCard({ envelope }: { envelope: CTSEnvelope }) {
    ...
    return (
        <button
            ...
            className="flex-shrink-0 w-56 bg-cortex-bg border border-cortex-primary/30 rounded-lg p-3 text-left hover:border-cortex-primary/60 hover:shadow-[0_0_12px_rgba(75,78,109,0.18)] transition-all duration-200 group"
        >
        ...
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-40 max-w-[80%]">
            <div className="bg-cortex-surface border border-cortex-primary/30 rounded-t-xl rounded-b-lg px-4 py-3 shadow-lg animate-pulse-subtle">
                ...
                <div className="flex items-center gap-2 mb-2.5">
                    <div className="w-2 h-2 rounded-full bg-cortex-success shadow-[0_0_6px_rgba(132,220,198,0.55)] animate-pulse" />

...
def test_docs_manifest_exposes_required_canonical_docs():
    ...
    required_paths = [
        ...
        "docs/architecture-library/V8_3_UI_UX_ENGINEERING_IMPLEMENTATION_BRIEF.md", "docs/architecture-library/V8_NEW_USER_ACCEPTANCE_MATRIX.md", "docs/architecture-library/V8_RUNTIME_CONTRACTS.md",
...
def test_readme_has_fresh_agent_review_sequence():
    ...
    required_refs = [
        ...
        "docs/architecture-library/V8_3_UI_UX_ENGINEERING_IMPLEMENTATION_BRIEF.md", "docs/architecture-library/V8_3_MVP_UI_RUNTIME_DELIVERY_PLAN.md", "docs/architecture-library/V8_UI_API_AND_OPERATOR_EXPERIENCE_CONTRACT.md",
...
def test_playwright_docs_reflect_owned_server_and_browser_matrix():
    expectations = {
        ...
        ROOT / "docs" / "architecture" / "OPERATIONS.md": [
            ...
            "built production Interface server path",
            "Chromium authenticated-front-door smoke",
            "uv run inv ci.service-check",
        ],
    }
